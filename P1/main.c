...
int main(void)
{
    ...
    {
    case 1:
        mvwprintw(fenetre, 21,4,"Vous avez choisit 1joueur redirection en cours");//passer à la page 2 1 joueur
        break;
    case 2:
        mvwprintw(fenetre, 21,4,"Vous avez choisit Autoplayer redirection en cours");
